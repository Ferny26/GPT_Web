            ...
            <div class="row">
              <div class="col-4">
                  <div class="form-group">
                      ...
                      <input name="fecha_adopcion" type="date" class="form-control">
                  </div>
              </div>
                <div class="col-4">
                    <div class="form-group">
...
<div class="col-4">
                <div class="form-group">
                    <h5>Nombre:</h5>
                    <input name="Nombres" type="text" class="form-control" placeholder="Ej: Claudia">
                </div>
              </div>
              ...
              <div class="col-4">
                <div class="form-group">
                    <h5>Celular:</h5>
                    <input name="Celular" type="text" class="form-control" placeholder="Ej: 3336627736">
                </div>
              </div>
              <div class="col-4">
